   <?php
    ...
    <?php
      ...
      echo "Proszę wpisać nazwę Gry, której swoją recenzje chcesz usunąć: ";
    ?>
    ...
    <?php
      if($search_phrase) {
        ...
        $sql = "DELETE FROM recenzja WHERE idKonto = (SELECT idKonto FROM Konto WHERE nazwaKonto='$nazwagracza') AND idGra = (SELECT idGra FROM Gra WHERE nazwaGra='$search_phrase');";
